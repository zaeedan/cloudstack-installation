...
1. Core: ditujukan untuk data center, memiliki range jaringan yang cukup luas dan memberikan akses pada fungsionalitas lainnya di Apache Cloudstack.
2. Edge: disebut lightweight zone, digunakan untuk layanan publik atau aplikasi yang diakses dari luar. Fungsionalitas terbatas dibandingkan tipe Core.
Pada langkah ini, pilih yang tipe Core.

Selanjutnya memilih Core Zone Type.
1. Advanced: lebih fleksibel dan bisa bikin banyak jaringan (public/private).
2. Basic: lebih sederhana, semua VM di 1 jaringan dan cocok untuk testing.
